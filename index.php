...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@BARATON.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+254 728 481648</li>	
					<li class="s-bar">
						<div class="search">
				   ...
				   <div class="ab-w3l-spa">
						   ...
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>You'll love everything here. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Emmanuel Kiptoo</h4>
							<span>Manager</span>
							<p>We ensure we deliver the best through our able team .</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Kelvin Agoi</h4>
							<span>Assisstant Manager</span>
							<p>Our customer our priority.</p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
